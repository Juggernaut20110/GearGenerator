...
def derived_rows(geo: SpurSetGeometry) -> list[Row]:
    ...
    return [
        ...
        Row("tip alteration coefficient k", _n(geo.tip_alteration_coefficient)),
        Row("working depth h_w", _n(geo.working_depth), unit="mm"),
        Row(
            "tip clearance c_1 / c_2",
            _n(geo.tip_clearance_1),
            _n(geo.tip_clearance_2),
            "mm",
        ),
        Row("minimum tip clearance", _n(geo.minimum_tip_clearance), unit="mm"),
        Row("backlash input", _n(geo.requested_backlash), unit="mm"),
        Row("backlash definition", geo.backlash_mode),
        Row("backlash allocation to pinion", _n(geo.backlash_allocation)),
        Row("reference circumferential backlash j_t", _n(geo.j_t), unit="mm"),
        Row("working circumferential backlash j_wt", _n(geo.j_wt), unit="mm"),
        Row("transverse backlash j_bt", _n(geo.j_bt), unit="mm"),
        Row("normal-base backlash j_bn", _n(geo.j_bn), unit="mm"),
        Row("working normal backlash j_wn", _n(geo.j_wn), unit="mm"),
        Row("radial backlash j_r", _n(geo.j_r), unit="mm"),
        Row(
            "angular backlash phi_j1 / phi_j2",
            _n(geo.angular_backlash_1),
            _n(geo.angular_backlash_2),
            "rad",
        ),
        ...
        Row(
            ...
            _n(a.working_tooth_thickness),
            _n(b.working_tooth_thickness),
            "mm",
        ),
        Row(
            "reference tooth-thickness allowance",
            _n(a.reference_tooth_thickness_allowance),
            _n(b.reference_tooth_thickness_allowance),
            "mm",
        ),
        Row(
            "working tooth-thickness allowance",
            _n(a.working_tooth_thickness_allowance),
            _n(b.working_tooth_thickness_allowance),
            "mm",
        ),
