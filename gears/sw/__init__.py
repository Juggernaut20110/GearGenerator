...
There are four assembly builders and three part builders. A planetary train is
made of spur gears - an external sun, external planets and an internal ring -
so `spur_part` builds all three of its parts and only the *assembly* has
anything new in it.
"""
...
from .hypoid_assembly import HypoidSetResult, build_hypoid_set
